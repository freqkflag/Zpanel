...
class SettingsBackup extends Component
{
    ...
    public function mount()
    {
        ...
        $this->database = StandalonePostgresql::whereName('zpanel-db')->first();
    ...
    public function addZpanelDatabase()
    {
        try {
            $server = Server::findOrFail(0);
            $out = instant_remote_process(['docker inspect zpanel-db'], $server);
