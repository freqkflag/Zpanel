<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for Zpanel instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your Zpanel instance, you first need to add a database resource
                    into Zpanel.
                    <x-forms.button class="mt-2" wire:click="addZpanelDatabase">Configure Backup</x-forms.button>
                @endif
            @else
