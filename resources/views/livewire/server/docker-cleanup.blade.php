<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Docker Cleanup | Zpanel
    </x-slot>
                        ...
                        @can('update', $server)
                            <x-modal-confirmation title="Confirm Docker Cleanup?" buttonTitle="Trigger Manual Cleanup"
                                isHighlightedButton submitAction="manualCleanup" :actions="[
                                    'Permanently deletes all stopped containers managed by Zpanel (as containers are non-persistent, no data will be lost)',
                                    'Permanently deletes all unused images',
                                    'Clears build cache',
                                    'Removes old versions of the Zpanel helper image',
                    ...
                    <div class="w-full sm:w-96">
                        <x-forms.checkbox canGate="update" :canResource="$server"
                            ...
                            <ul class='list-disc pl-4 mt-2'>
                                <li>Removes stopped containers managed by Zpanel (as containers are non-persistent, no data will be lost).</li>
                                <li>Deletes unused images.</li>
                                <li>Clears build cache.</li>
                                <li>Removes old versions of the Zpanel helper image.</li>
