<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > CA Certificate | Zpanel
    </x-slot>
                    ...
                    <div class="flex gap-2">
                        <x-modal-confirmation title="Confirm changing of CA Certificate?" buttonTitle="Save"
                            submitAction="saveCaCertificate" :actions="[
                                'This will overwrite the existing CA certificate at /data/zpanel/ssl/zpanel-ca.crt with your custom CA certificate.',
                            ...
                            confirmationText="/data/zpanel/ssl/zpanel-ca.crt" shortConfirmationLabel="CA Certificate Path"
                        ...
                        <x-modal-confirmation title="Confirm Regenerate Certificate?" buttonTitle="Regenerate "
                            submitAction="regenerateCaCertificate" :actions="[
                                'This will generate a new CA certificate at /data/zpanel/ssl/zpanel-ca.crt and replace the existing one.',
            ...
            <div class="space-y-4">
                <div class="text-sm">
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        <li>Mount this CA certificate of Zpanel into all containers that need to connect to one of
                ...
                <div class="relative">
                    <x-forms.copy-button text="- /data/zpanel/ssl/zpanel-ca.crt:/etc/ssl/certs/zpanel-ca.crt:ro" />
                </div>
            </div>
            <div>
