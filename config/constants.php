...
return [
    'coolify' => [
        ...
        'base_config_path' => env('BASE_CONFIG_PATH', '/data/zpanel'),
        'registry_url' => env('REGISTRY_URL', 'ghcr.io'),
        'helper_image' => env('HELPER_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/freqkflag/zpanel-helper'),
        'realtime_image' => env('REALTIME_IMAGE', env('REGISTRY_URL', 'ghcr.io').'/freqkflag/zpanel-realtime'),
